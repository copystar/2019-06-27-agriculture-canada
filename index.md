...
venue: "Harrow R&D Centre, Agriculture Canada"        # brief name of host site without address (e.g., "Euphoric State University")
address: "2585 County Road 20, Harrow, Ontario, N0R 1G0"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "42.035586, -82.918359"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
email: ["Bukola.Aremu@uwindsor.ca","Mita Williams"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: etherpad forthcoming   # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
